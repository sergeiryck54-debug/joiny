...
const TR: Record<string, Record<Lang, string>> = {
  ...
  'create.day': { EN: 'DAY', RU: 'ДЕНЬ', TH: 'วัน' },
  'create.time': { EN: 'TIME', RU: 'ВРЕМЯ', TH: 'เวลา' },
  'create.today': { EN: 'Today', RU: 'Сегодня', TH: 'วันนี้' },
  'create.tomorrow': { EN: 'Tomorrow', RU: 'Завтра', TH: 'พรุ่งนี้' },
  'create.at': { EN: 'at', RU: 'в', TH: 'เวลา' },
  ...
  'media.unavailableTitle': { EN: 'Photo check', RU: 'Проверка фото', TH: 'การตรวจสอบรูป' },
  'media.unavailable': { EN: 'Photo check is temporarily unavailable, please try again later. You can create the event without a photo.', RU: 'Проверка фото временно недоступна, попробуйте позже. Событие можно создать и без фото.', TH: 'การตรวจสอบรูปไม่พร้อมใช้งานชั่วคราว ลองอีกครั้งภายหลัง คุณสร้างกิจกรรมได้โดยไม่ต้องมีรูป' },
  'media.unavailableShort': { EN: 'Photo check is temporarily unavailable, please try again later.', RU: 'Проверка фото временно недоступна, попробуйте позже.', TH: 'การตรวจสอบรูปไม่พร้อมใช้งานชั่วคราว ลองอีกครั้งภายหลัง' },
  ...
  'notif.unreadTitle': { EN: 'Unread chats', RU: 'Непрочитанные чаты', TH: 'แชทที่ยังไม่อ่าน' },
  'notif.unreadCount': { EN: '{n} new', RU: '{n} новых', TH: '{n} ใหม่' },
  'notif.openChat': { EN: 'Open chat →', RU: 'Открыть чат →', TH: 'เปิดแชท →' },
